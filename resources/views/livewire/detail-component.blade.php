                        ...
                        <div class="product-gallery">
                          <ul class="slides">
                            ...
                            <li data-thumb="{{ asset('assets/images/products/digital_8.jpg') }}">
                                <img src="{{ asset('assets/images/products/digital_.jpg') }}" alt="product thumbnail" />
                            </li>

                            <li data-thumb="{{ asset('assets/images/products/digital_1.jpg') }}">
                                <img src="{{ asset('assets/images/products/digital_1.jpg') }}" alt="product thumbnail" />
                            </li>
                            ...
                            <li data-thumb="{{ asset('assets/images/products/digital_4.jpg') }}">
                                <img src="{{ asset('assets/images/products/digital_4.jpg') }}" alt="product thumbnail" />
                            </li>
